...
public:
    ...
    EffectSettingModelImpl(const EffectInstanceId instanceId, QObject* parent, LabelMap labelMap, ParamGetter<EffectType> getter)
        : BuiltinEffectSettingModel{instanceId, parent}, m_labelMap{std::move(labelMap)}, m_getter{std::move(getter)} {}
