...
#include "effects/plugins/internal/pluginstypes.h"
...
muse::String utils::effectFamilyToString(EffectFamily family)
{
    ...
    case EffectFamily::Plugin: return u"Plugin";
    default:
        assert(false);
        return u"Unknown";
    }
...
std::string utils::effectFamilyToCacheType(EffectFamily family)
{
    ...
    case EffectFamily::Plugin:    return std::string(plugins::AUDIO_RESOURCE_TYPE_NAME);
...
EffectFamily utils::effectFamilyFromCacheType(const std::string& cacheType)
{
    ...
    if (cacheType == plugins::AUDIO_RESOURCE_TYPE_NAME) {
        return EffectFamily::Plugin;
    }
    return EffectFamily::Unknown;
}
