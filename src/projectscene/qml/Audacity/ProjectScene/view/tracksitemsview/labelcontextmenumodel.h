...
class LabelContextMenuModel : public muse::uicomponents::AbstractMenuModel
{
    ...
    Q_PROPERTY(au::projectscene::LabelKey labelKey READ labelKey WRITE setLabelKey NOTIFY labelKeyChanged FINAL)
...
public:
    ...
    void setLabelKey(const au::projectscene::LabelKey& key);
