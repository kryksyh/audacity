...
bool TrackClipsListModel::changeClipTitle(const au::projectscene::ClipKey& key, const QString& newTitle)
{
...
void TrackClipsListModel::openClipPitchEdit(const au::projectscene::ClipKey& key)
{
    selectClip(key);
...
void TrackClipsListModel::resetClipPitch(const au::projectscene::ClipKey& key)
{
    trackeditInteraction()->resetClipPitch(key.key);
}

void TrackClipsListModel::openClipSpeedEdit(const au::projectscene::ClipKey& key)
{
    selectClip(key);
...
void TrackClipsListModel::resetClipSpeed(const au::projectscene::ClipKey& key)
{
...
au::projectscene::ClipKey TrackClipsListModel::updateClipTrack(au::projectscene::ClipKey clipKey) const
{
    ...
    for (const auto& trackId : allTracks) {
        ...
        for (const auto& clip : clips) {
            if (clip.key.itemId == clipKey.key.itemId) {
                au::projectscene::ClipKey updatedKey;
 ...
 */
bool TrackClipsListModel::moveSelectedClips(const au::projectscene::ClipKey& key, bool completed)
{
    ...
    au::projectscene::ClipKey updatedKey = key;
...
bool TrackClipsListModel::trimLeftClip(const au::projectscene::ClipKey& key, bool completed, ClipBoundary::Action action)
{
    TrackClipItem* item = clipItemByKey(key.key);
...
bool TrackClipsListModel::trimRightClip(const au::projectscene::ClipKey& key, bool completed, ClipBoundary::Action action)
{
    TrackClipItem* item = clipItemByKey(key.key);
    IF_ASSERT_FAILED(item) {
        return false;
...
bool TrackClipsListModel::stretchLeftClip(const au::projectscene::ClipKey& key, bool completed, ClipBoundary::Action action)
{
    TrackClipItem* item = clipItemByKey(key.key);
    IF_ASSERT_FAILED(item) {
        return false;
...
bool TrackClipsListModel::stretchRightClip(const au::projectscene::ClipKey& key, bool completed, ClipBoundary::Action action)
{
    TrackClipItem* item = clipItemByKey(key.key);
    IF_ASSERT_FAILED(item) {
        return false;
...
void TrackClipsListModel::selectClip(const au::projectscene::ClipKey& key)
{
