...
public:
    ...
    Q_INVOKABLE bool moveSelectedClips(const au::projectscene::ClipKey& key, bool completed);
    Q_INVOKABLE bool trimLeftClip(const au::projectscene::ClipKey& key, bool completed, ClipBoundary::Action action = ClipBoundary::Action::Shrink);
    Q_INVOKABLE bool trimRightClip(const au::projectscene::ClipKey& key, bool completed, ClipBoundary::Action action = ClipBoundary::Action::Shrink);
    Q_INVOKABLE bool stretchLeftClip(const au::projectscene::ClipKey& key, bool completed, ClipBoundary::Action action = ClipBoundary::Action::Shrink);
    Q_INVOKABLE bool stretchRightClip(const au::projectscene::ClipKey& key, bool completed, ClipBoundary::Action action = ClipBoundary::Action::Shrink);

    Q_INVOKABLE void selectClip(const au::projectscene::ClipKey& key);
    Q_INVOKABLE void resetSelectedClips();
    Q_INVOKABLE bool changeClipTitle(const au::projectscene::ClipKey& key, const QString& newTitle);

    Q_INVOKABLE void openClipPitchEdit(const au::projectscene::ClipKey& key);
    Q_INVOKABLE void resetClipPitch(const au::projectscene::ClipKey& key);

    Q_INVOKABLE void openClipSpeedEdit(const au::projectscene::ClipKey& key);
    Q_INVOKABLE void resetClipSpeed(const au::projectscene::ClipKey& key);

    // update clip after moving to other track
    Q_INVOKABLE au::projectscene::ClipKey updateClipTrack(au::projectscene::ClipKey clipKey) const;
