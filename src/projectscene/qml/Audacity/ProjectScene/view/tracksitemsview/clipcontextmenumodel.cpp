...
static inline bool containsAny(const ActionCodeList& list, const ActionCodeList& actionCodes)
{
...
au::projectscene::ClipKey ClipContextMenuModel::clipKey() const
{
    return m_clipKey;
}

void ClipContextMenuModel::setClipKey(const au::projectscene::ClipKey& newClipKey)
{
